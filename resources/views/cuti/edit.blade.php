                        ...
                        <div class="col-sm-10">
                            <select name="karyawan_id" id="karyawan_id" class="form-select @error('karyawan_id') is-invalid @enderror">
                                ...
                                @foreach ($karyawans as $karyawan)
                                    <option value="{{ $karyawan->id }}" {{ $cuti->karyawan_id == $karyawan->id ? 'selected' : '' }}>{{ $karyawan->nama }}</option>
                                @endforeach
                            </select>
                            @error('karyawan_id')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="jenis_cuti" id="jenis_cuti" class="form-select @error('jenis_cuti') is-invalid @enderror">
                                ...
                                <option value="liburan" {{ $cuti->jenis_cuti== 'liburan' ? 'selected' : '' }}>Liburan</option>
