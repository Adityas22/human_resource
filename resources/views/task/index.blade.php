                    ...
                    <table class="table table-striped" id="dataTable">
                        ...
                        <tbody>
                            @foreach ($tasks as $task)
                                    ...
                                    <td>
                                        ...
                                        @if (session('role') == 'HR')
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#modalHapus{{ $task->id }}">
                                                Hapus
                                            </button>
                                        @endif
                                    </td>
                                ...
                                <div class="modal fade" id="modalHapus{{ $task->id }}" tabindex="-1"
                                    aria-labelledby="modalHapusLabel{{ $task->id }}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 shadow">
                                            <div class="modal-header bg-danger text-white">
                                                <h5 class="modal-title" id="modalHapusLabel{{ $task->id }}">
                                            ...
                                            <div class="modal-body text-center">
                                                <p>Apakah kamu yakin ingin menghapus task
                                                    <strong>{{ $task->nama }}</strong> ini?
                                                </p>
                                            </div>
