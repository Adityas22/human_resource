    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Manajemen Edit Data Karyawan</h5>
            </div>
            <div class="card-body">
                @if (session('error'))
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nama" id="nama"
                                placeholder="Isikan Nama Tugas" value="{{old('nama', $karyawan->nama)}}">
                            @error('nama')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nomor_hp" id="nomor_hp"
                                placeholder="Isikan nomor_hp" value="{{old('nomor_hp', $karyawan->nomor_hp)}} ">
                            @error('nomor_hp')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="alamat" id="alamat"
                                placeholder="Isikan alamat" value="{{old('alamat', $karyawan->alamat)}} ">
                            @error('alamat')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('tgl_lahir') is-invalid @enderror"
                                    name="tgl_lahir" id="tgl_lahir" placeholder="Pilih tanggal & waktu"
                                    value="{{ old('tgl_lahir') }}">
                            </div>
                            @error('tgl_lahir')
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('tgl_rekrutment') is-invalid @enderror"
                                    name="tgl_rekrutment" id="tgl_rekrutment" placeholder="Pilih tanggal & waktu"
                                    value="{{ old('tgl_rekrutment') }}">
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="roles_id" id="roles_id"
                                ...
                                <option value="{{ $role->id }}" @if (old('roles_id')==$role->id) selected
                                    @endif>{{ $role->nama }}</option>
                                @endforeach
                            </select>
                            @error('roles_id')
                            <div class="alert alert-danger mt-2">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="departemen_id" id="departemen_id"
                                ...
                                <option value="{{ $departemen->id }}" @if (old('departemen_id')==$departemen->id) selected
                                    @endif>{{ $departemen->nama }}</option>
                                @endforeach
                            </select>
                            @error('departemen_id')
                            <div class="alert alert-danger mt-2">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select name="status" id="status" class="form-select @error('status') is-invalid @enderror">
                                ...
                                <option value="nonaktif" @if (old('status', $karyawan->status)=='nonaktif') selected
                                    @endif>Non-Aktif</option>
                                <option value="aktif" @if (old('status', $karyawan->status)=='aktif') selected
                                    @endif>Aktif</option>
                            </select>
                            @error('status')
                            <div class="alert alert-danger mt-2">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="gaji" id="gaji"
                                placeholder="Isikan gaji" value="{{old('gaji', $karyawan->gaji)}} ">
                            @error('gaji')
                            <div class="alert alert-danger mt-2">
                                {{ $message }}
                            </div>
