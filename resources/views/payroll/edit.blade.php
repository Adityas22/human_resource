    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Manajemen Edit Data Payroll</h5>
            </div>
            <div class="card-body">
                            ...
                            <select name="karyawan_id" id="karyawan_id" class="form-select @error('karyawan_id') is-invalid @enderror">
                                ...
                                @foreach ($karyawans as $karyawan)
                                    <option value="{{ $karyawan->id }}" 
                                        ...
                                        {{ old('karyawan_id', $payroll->karyawan_id) == $karyawan->id ? 'selected' : '' }}>
                                        {{ $karyawan->nama }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input 
                                ...
                                name="gaji_bersih" 
                                id="gaji_bersih"
                                value="{{ old('gaji_bersih', $payroll->gaji_bersih) }}"
                                readonly>
                            @error('gaji_bersih')
                                <div class="alert alert-danger mt-2">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input 
                                    ...
                                    name="tgl_pembayaran" 
                                    id="tgl_pembayaran"
                                    value="{{ old('tgl_pembayaran', $payroll->tgl_pembayaran) }}">
                            </div>
...
{{-- Inisialisasi Datepicker & Hitung Gaji Otomatis --}}
<script>
